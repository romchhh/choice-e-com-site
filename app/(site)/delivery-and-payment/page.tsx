        ...
        <div className="space-y-12 text-base leading-relaxed">
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="opacity-80">
                Накладений платіж здійснюється при замовленні від <strong>200 грн</strong>.
                Також ви можете заощадити цю суму, провівши повну оплату вартості товару на карту
                Приватбанку.
              </p>
            </div>
